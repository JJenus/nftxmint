	...
	>
		...
		>
			...
			<div class="app-navbar flex-shrink-0" id="kt_app_aside_navbar">
							...
							>
								...
								<div class="py-3 text-center border-top">
									...
									>
										View All
										<i
											class="ki-outline ki-arrow-right fs-5"
										></i>
									</a>
								</div>
								<!--end::View more-->
							...
							>
								...
								<div class="d-flex flex-column px-9">
									...
									<div class="pt-10 pb-0">
										<!--begin::Title-->
										<h3
											class="text-dark text-center fw-bold"
										>
											Get Pro Access
										</h3>
										<!--end::Title-->
				...
				<!--begin::Activities-->
				<div
					class="app-navbar-item d-flex justify-content-end flex-grow-1 ms-1 ms-lg-3"
				>
					<!--begin::Drawer toggle-->
					<div
						class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px"
						...
						<div class="row g-0">
							...
							<div class="col-6">
								...
								>
									...
									></i>
									<span
										class="fs-5 fw-semibold text-gray-800 mb-0"
										>Accounting</span
									>
							...
							>
								...
								<div class="menu-item px-3 my-0">
									...
									>
										...
										>
											<i
												class="ki-outline ki-night-day fs-2"
											></i>
										</span>
								...
								<div class="menu-item px-3 my-0">
									...
									>
										...
										>
											<i
												class="ki-outline ki-screen fs-2"
											></i>
										</span>
